...
urlpatterns = [
    ...
    path('courier_profile/<int:pk>/comment/', views.add_comment, name='courier_profile'),
    path('courier_profile/<int:pk>/', views.CourierDetailView.as_view(), name='courier_profile'),
    path('courier_form/', views.contact_view, name='contact_view'),
    path('courier_form/success/', views.success_view, name='success'),
    path('new_order/', views.new_order, name='new_order'),
    path('orders_list/<int:order_id>/accept/', views.accept_order, name='accept_order'),
